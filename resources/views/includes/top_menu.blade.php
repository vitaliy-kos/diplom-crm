                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                            ...
                            <!-- <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="notification-dropdown">
                                <div class="card shadow-none m-0 border-0">
                                        ...
                                        <ul class="dropdown-menu-1 overflow-auto list-style-1 mb-0">
                                            <li class="dropdown-item-1 float-none p-3">
                                                <div
                                                    ...
                                                    <div class="list-style-detail ml-2 mr-2">
                                                        <h6 class="font-weight-bold">Новый заказ</h6>
                                                        <p class="m-0">
                                                            <small class="text-secondary">Капельница</small>
                                                        </p>
                                                        <p class="m-0">
                                            ...
                                            <li class="dropdown-item-1 float-none p-3">
                                                <div
                                                    ...
                                                    <div class="list-style-detail ml-2 mr-2">
                                                        <h6 class="font-weight-bold">Новое сообщение</h6>
                                                        <p class="m-0">
                                                            <small class="text-secondary">У вас 3 непрочитанных
                                                                сообщения</small>
                                                        </p>
                                                        <p class="m-0">
                                                            <small class="text-secondary">
                                            ...
                                            <li class="dropdown-item-1 float-none p-3">
                                                <div
                                                    ...
                                                    <div class="list-style-detail ml-2 mr-2">
                                                        <h6 class="font-weight-bold">Услуга оказана</h6>
                                                        <p class="m-0">
                                                            <small class="text-secondary">Выезд капельница</small>
                                                        </p>
                                                        <p class="m-0">
                                                            <small class="text-secondary">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="card-footer text-muted p-3">
                                        <p class="mb-0 text-primary text-center font-weight-bold">Показать все
                                            уведомления</p>
                                    </div>
                                </div>
                            </div> -->
                        ...
                        <!-- <li class="nav-item nav-icon dropdown">
                            ...
                            <img src="/wp-content/themes/kivicare/crm-template/assets/images/Flag/flag001.png" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
                            <span class="bg-primary"></span>
                            </a>
                                ...
                                <div class="card shadow-none m-0 border-0">
                                    <div class=" p-0 ">
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="/wp-content/themes/kivicare/crm-template/assets/images/Flag/flag-03.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>Spanish</a></li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="/wp-content/themes/kivicare/crm-template/assets/images/Flag/flag-04.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>Italian</a></li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="/wp-content/themes/kivicare/crm-template/assets/images/Flag/flag-02.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>French</a></li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="/wp-content/themes/kivicare/crm-template/assets/images/Flag/flag-05.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>German</a></li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="/wp-content/themes/kivicare/crm-template/assets/images/Flag/flag-06.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;"/>Japanese</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle"
                               ...
                               aria-expanded="false">
                                ...
                                <span
                                    class="mb-0 ml-2 user-name"><?php //echo $user_meta['first_name'][0] . ' ' . $user_meta['last_name'][0] ?></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <!-- <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="../app/user-profile.html">Мой профиль</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="../app/user-profile-edit.html">Редактировать</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
