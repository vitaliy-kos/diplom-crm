        ...
        <div class="row">
            <div class="col-md-12 mb-4 mt-1">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <h4 class="font-weight-bold">Вид поломки
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('crm.brokenType.edit', $brokenType->id) }}" class="btn btn-outline-success sml-btn but-square p-2">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col">
                                ...
                                <select name="technic_type_id" class="form-control choicesjs" disabled>
                                    ...
                                    @foreach ($technics_types as $technics_type)
                                        <option value="{{ $technics_type->id }}" {{ $technics_type->id === (int) $brokenType->technic_type_id ? 'selected' : '' }}>{{ $technics_type->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $brokenType->name }}" placeholder="" disabled>
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea class="form-control" name="description" rows="3" disabled>{{ $brokenType->description }}</textarea>
                            </div>
                        </div>
