        ...
        <div class="row">
            <div class="col-md-12 mb-4 mt-1">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <h4 class="font-weight-bold">Редактирование пользователя
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('crm.user.show', $user->id) }}" class="btn btn-outline-primary sml-btn but-square p-2">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('crm.user.update', $user->id)}}">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="col">
                                    ...
                                    <select name="role" class="form-control choicesjs">
                                        ...
                                        @foreach($roles as $id => $role)
                                            <option value="{{ $id }}" {{ $id === old('role', $user->role) ? 'selected' : '' }}>{{ $role }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
