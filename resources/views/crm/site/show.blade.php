        ...
        <div class="row">
            <div class="col-md-12 mb-4 mt-1">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <h4 class="font-weight-bold">Сайт
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('crm.site.edit', $site->id) }}" class="btn btn-outline-success sml-btn but-square p-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row mt-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $site->name }}" placeholder="" disabled>
                            </div>
                        </div>
