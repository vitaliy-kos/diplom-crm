        ...
        <div class="row">
            <div class="col-md-12 mb-4 mt-1">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <h4 class="font-weight-bold">Редактирование расхода
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('crm.expense.show', $expense->id) }}" class="btn btn-outline-primary sml-btn but-square p-2">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('crm.expense.update', $expense->id)}}">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="col">
                                    ...
                                    <select name="type_id" class="form-control choicesjs">
                                        ...
                                        @foreach($expense_types as $type)
                                            <option
                                                value="{{ $type->id }}" {{ $type->id === (int) old('type_id', $expense->type_id) ? 'selected' : '' }}>{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 mt-2">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input type="text" name="sum"
                                               ...
                                               maxlength="7"
                                               value="{{ old('sum', $expense->sum) }}" required>
                            ...
                            <div class="mt-1">
                                <div class="form-group text-center">
                                    ...
                                    <textarea class="form-control" name="comment"
                                              rows="2">{{ old('comment', $expense->comment) }}</textarea>
                                </div>
                            </div>
