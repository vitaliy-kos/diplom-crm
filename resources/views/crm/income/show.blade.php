        ...
        <div class="row">
            <div class="col-md-12 mb-4 mt-1">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <h4 class="font-weight-bold">Приход
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('crm.income.edit', $income->id) }}" class="btn btn-outline-success sml-btn but-square p-2">
                                ...
                                <div class="col">
                                    ...
                                    <select name="type_id" class="form-control choicesjs" disabled>
                                        ...
                                        @foreach($income_types as $type)
                                            <option
                                                value="{{ $type->id }}" {{ $type->id === $income->type_id ? 'selected' : '' }}>{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mt-1">
                                <div class="form-group text-center">
                                    ...
                                    <textarea class="form-control"
                                              rows="2" disabled>{{ $income->comment }}</textarea>
                                </div>
                            </div>
                        </form>
